...
class ProductVariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_variant" do
    assert_difference('ProductVariant.count') do
      post product_variants_url, params: { product_variant: { batch_no: @product_variant.batch_no, expiry: @product_variant.expiry, price: @product_variant.price, products_id: @product_variant.products_id, quantity: @product_variant.quantity, weight: @product_variant.weight } }
    end
  ...
  test "should update product_variant" do
    patch product_variant_url(@product_variant), params: { product_variant: { batch_no: @product_variant.batch_no, expiry: @product_variant.expiry, price: @product_variant.price, products_id: @product_variant.products_id, quantity: @product_variant.quantity, weight: @product_variant.weight } }
